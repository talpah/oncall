var DataTable = (function () {
    function DataTable(element, columns, prefix) {
        this.reset(element, columns, prefix);
    }

    DataTable.prototype.reset = function (element, columns, prefix) {
        this.table = {};
        this.data = {};
        if (!element) {
        ...
        if (!columns) {
            throw new Error('Invalid lines/columns.')
        }
